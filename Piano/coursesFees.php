...
<body>
  <nav class="navbar navbar-dark navbar-expand-sm" style="background-color: #323232" ;>
    <div class=" container">
      <a class="navbar-brand" href=""><img src="logo.png" alt="" class="rounded-circle border" height="60"
          width="60">
        Piano Academy</a>
  ...
  <div class="container my-5">
    <table class="table table-striped table-hover table-bordered border-primary pd">
      <thead>
        <tr>
          <th scope="col" class="table-warning">Sl.No</th>
          <th scope="col" class="table-warning">Courses</th>
          <th scope="col" class="table-warning">Fees</th>
        </tr>
      </thead>
      <tbody>
        <tr>
