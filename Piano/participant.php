...
<body style="background:url(piano.jpg)">
  ...
  <div id="background" style="
    ...
    background-image: url('blue_piano.jpg'); /*background-color: rgb(241, 185, 178);*/ min-height: 680px;">
    <h1 class="display-4 pt-2" style="text-align:center;font-weight:500;color:white;">Registration Form for
      Students</h1>
    <div class="">
...
<?php
    if(isset($_POST['submit'])){
        ...
        $query = "insert into participant values(null,'$_POST[name]','$_POST[gender]','$_POST[age]','$_POST[city]','$_POST[contact]', '$_POST[r_d]')";
        $query_run = mysqli_query($connection,$query);
    ?>
<script type="text/javascript">
alert("Participant Add Successfully...");
